...
public class PinController {
    ...
    public ResponseEntity<PinToggleResponse> togglePinMessage(
        ...
        PinToggleResponse response = messageService.togglePinMessage(messageId, userPrincipal.getId());
    ...
    public ResponseEntity<List<MessageResponse>> getPinnedMessages(
        ...
        List<MessageResponse> responses = messageService.getPinnedMessages(roomId, userPrincipal.getId());
